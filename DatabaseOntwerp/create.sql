...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `jverhoev5_db`.`users_categories` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `jverhoev5_db`.`users_read_replies` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `jverhoev5_db`.`news` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `jverhoev5_db`.`menu` ;
